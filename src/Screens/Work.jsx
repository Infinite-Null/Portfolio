...
function Work() {
    ...
    return (
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-[120px_1fr] lg:gap-8 py-12 px-36">
            <div className="rounded-lg flex flex-col items-center justify-start pt-20">
